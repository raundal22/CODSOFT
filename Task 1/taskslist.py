...
class TasksList:
  ...
  def __init__(self, task_list=None, date=None):
    ...
    self.task_textbox = tk.Text(master=self.new_task_window,
                                width=55,
                                height=2)
    self.task_textbox.grid(row=3,
                           column=0,
                           columnspan=2,
                           sticky="W",
                           pady=(20, 0))
    ...
    self.task_listbox = tk.Listbox(master=self.new_task_window,
                                   height=15,
                                   width=73)
    self.task_listbox.grid(row=5,
                           column=0,
                           columnspan=2,
                           sticky="W",
                           pady=(20, 0))
  ...
  def listbox_used(self, selection):
    ...
    if self.task_listbox.curselection():
      self.selected_task = self.task_listbox.get(
